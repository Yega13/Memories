...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      'Poster thumbnails auto-generated for every video',
      'Up to 200 MB per file on Pro and Max plans',
    ],
  },
  {
    emoji: '🔒',
  ...
  },
  {
    ...
    items: [
      ...
      'Filenames use captions when available, otherwise numbered automatically',
  ...
  },
  {
    ...
    color: '#1A2B1A',
    items: [
      'Free: unlimited albums, 12-month inactivity expiry, photos up to 25 MB, real-time gallery',
      'Pro ($4/month): password protection, custom URLs, no expiry, HD video, 200 MB uploads',
