  ...
  return (
    <div className="hush-container hush-home-grid hush-fade-up relative z-10 pt-10 pb-14 lg:pt-16 lg:pb-24 grid grid-cols-1 lg:grid-cols-[minmax(0,0.9fr)_minmax(520px,1.1fr)] gap-10 lg:gap-16 2xl:gap-24 items-center lg:min-h-[calc(100vh_-_73px)]">
      ...
      <div className="hush-home-visuals relative hidden lg:flex items-center justify-center" style={{ height: 'clamp(460px, 36vw, 600px)' }}>
        ...
        {/* Top-left */}
        <div onPointerMove={tiltCard} onPointerLeave={resetTiltCard} className="hush-float-slow hush-tilt-card absolute rounded-2xl overflow-hidden shadow-2xl" style={{ ['--hush-rotate' as string]: '-5deg', top: '0%', left: '3%', width: 'clamp(160px, 11vw, 220px)', height: 'clamp(200px, 14vw, 280px)', border: '4px solid rgba(255,255,255,0.9)' }}>
        ...
        {/* Top-right */}
        <div onPointerMove={tiltCard} onPointerLeave={resetTiltCard} className="hush-float-slow hush-tilt-card absolute rounded-2xl overflow-hidden shadow-2xl" style={{ ['--hush-rotate' as string]: '4deg', animationDelay: '-1.8s', top: '-4%', right: '5%', width: 'clamp(155px, 10.5vw, 210px)', height: 'clamp(185px, 12.5vw, 255px)', border: '4px solid rgba(255,255,255,0.9)' }}>
        ...
        {/* Center — main card */}
        <div onPointerMove={tiltCard} onPointerLeave={resetTiltCard} className="hush-float-slow hush-tilt-card absolute rounded-2xl overflow-hidden shadow-2xl" style={{ ['--hush-rotate' as string]: '1deg', animationDelay: '-3.2s', top: '34%', left: '16%', width: 'clamp(210px, 14vw, 300px)', height: 'clamp(240px, 16vw, 340px)', border: '4px solid rgba(255,255,255,0.95)', zIndex: 10 }}>
